...
1. Continue the prioritized backlog in IMPLEMENTATION_STATUS.md. The largest untouched areas are the **performance gate** (item 1), **Windows accessibility/enterprise-proxy validation** (item 2), and **lazy collection loading plus disk-change detection with a comparison UI** (item 5).
